...
const runCommands = {
    win32: {
        ...
        link: () => shell.exec('mklink /D "%SPLUNK_HOME%\\etc\\apps\\total-market-cap" "%cd%\\demo\\splunk-app"'),
    },
    nix: {
        ...
        link: () => shell.exec('ln -s $PWD/demo/splunk-app $SPLUNK_HOME/etc/apps/total-market-cap-demo-app'),
    },
};
